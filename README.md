...
- It would need to lift a payload of at least 3.1lb, preferably 5lb, up to 4 inches with a single DC motor and battery as the power source.
...
We wanted the torque of the motor be amplified by the gear train to provide a pulley system which rotates a spool pulling the bottom of the scissor lift.
...
- Failure Criteria, Constant Lift Curves
- Identification of the highest loaded bolt joint with different analyses including
  - Tension
  - Shear
  - Failure
